...
#define E_ON  PORTC |=(1<<0);
#define E_OFF PORTC &= ~(1<<0);

#define RS_ON PORTC |=(1<<1);
#define RS_OFF PORTC &= ~(1<<1);

#define D4_ON PORTC |=(1<<2);
#define D4_OFF PORTC &= ~(1<<2);

#define D5_ON PORTC |=(1<<3);
#define D5_OFF PORTC &= ~(1<<3);

#define D6_ON PORTC |=(1<<4);
#define D6_OFF PORTC &= ~(1<<4);

#define D7_ON PORTC |=(1<<5);
#define D7_OFF PORTC &= ~(1<<5);
