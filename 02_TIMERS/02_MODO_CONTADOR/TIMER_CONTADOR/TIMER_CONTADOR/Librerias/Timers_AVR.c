...
void Timer1_Init(void){
	...
	//Temporización: 100ms; 350ms; 500ms		
	/*
	...
	ValorTimer = 65536 - ((100x10^-3 x 16x10^6)/64) 
...
void Timer1_ModoContador(void){
	...
	//TMR1 en como contador de eventos externos por flanco subida
	TCCR1B |= (1<<CS12)|(1<<CS11)|(1<<CS10);
	
	TCNT1 = 0; //cuenta empieza desde cero
